...
const Store = (function() {
  ...
  async function _init() {
    ...
    _raw = { atlas, tree, humans, windows, constraints, scenarios, method, graveyard, theses, meta };
